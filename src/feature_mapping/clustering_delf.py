...
def _main(IMAGE_DIRECTORY):
    ...
    with tf.train.MonitoredSession() as sess:
        ...
        for image_path in image_list:
            ...
            Extracting_cnt += 1
            printProgress(Extracting_cnt, len(image_list), 'Progress:', 'Complete', 1, 50)
        ...
        for image_2 in image_list:
            ...
            try:
                if match_images(results_dict, image_1, image_2) > 15:
                    count += 1
                    cluster_image = image_2.split('\\')[-1].split('_')[0]
                    cluster_list.append(cluster_image)
                    tmp.append(image_2)
            except:
                pass
...
def delete_info_list(list1, list2):
    for info in list2:
        list1.remove(info)
