...
work_dir = '/home/edu/haejoo/python/naver/sample_images/mobilenet_pb'

model_path = os.path.join(work_dir, '20000_1layer_mobilenet_v2.pb')
...
def extract_features():
    ...
    for img in img_paths:
        ...
        img_path = os.path.join(IMG_DIR, img_paths[cnt - 1])
