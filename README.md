...
Model | Hub Module | Output size | Score(n) | Fine_tune_Score(n)
:------:|:---------------:|:---------------------:|:-----------:|:--------------------:|
inception_v3 | [inception_v3](https://tfhub.dev/google/imagenet/inception_v3/feature_vector/1)| 2048 | 39.4(153) | 
inception_resnet_v2 |[inception_resnet_v2](https://tfhub.dev/google/imagenet/inception_resnet_v2/feature_vector/1)| 1536 | 29.1(153) | 100(28), 89(153)
...
<img width="700" alt="inception_resnet_v2 t-SNE" src="https://github.com/jaemin93/SimilarPictures/blob/master/graph/cluster_t-SNE_.png">
