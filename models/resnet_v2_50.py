"""
ResNet 클래스 입니다. Tensorflow Hub에서 다운받은 Pre-train 모델을 사용합니다.
"""
...
class ResNet_V2:
    def __init__(self):
        self.module_url = "https://tfhub.dev/google/imagenet/resnet_v2_50/feature_vector/1"
    ...
    def build_model(self):
        # build resnet v2 50 model using tensorflow hub
