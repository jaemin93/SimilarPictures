"""
MobileNet V1 클래스 입니다. Tensorflow Hub에서 다운받은 Pre-train 모델을 사용합니다.
"""
...
class MobileNet_V1:
    def __init__(self):
        self.module_url = "https://tfhub.dev/google/imagenet/mobilenet_v1_100_224/feature_vector/1"
    ...
    def build_model(self):
        # build mobilenet v1 100 224 model using tensorflow hub
