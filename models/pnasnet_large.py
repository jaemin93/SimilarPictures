"""
PnasNet 클래스 입니다. Tensorflow Hub에서 다운받은 Pre-train 모델을 사용합니다.
"""
...
class PnasNet:
    def __init__(self):
        self.module_url = "https://tfhub.dev/google/imagenet/pnasnet_large/feature_vector/2"
        ...
        self.output_size = 4320

    def build_model(self):
        # build pnasnet large model using tensorflow hub
